...
\NewDocumentCommand{\framedbox}{ O{} m }{%
  ...
  \begin{tikzpicture}
    ...
    }
    {
      ...
      \coordinate (toplineend) at
      ($(northeast) - (\offsetx, 0) - (0.25pt, 0)$);
      \coordinate (rightlinestart) at
      ($(northeast) - (0, \offsety) - (0, 0.2pt)$);
      \coordinate (bottomlinestart) at
      ($(southwest) + (\offsetx, 0) + (0.25pt, 0)$);
      \coordinate (leftlineend) at
    ...
    \draw[line width={\verticallinethickness}]
      ([xshift={\offsetx + \verticallinethickness / 2 + 0.25pt}] leftlinestart) --
      ([xshift={\offsetx + \verticallinethickness / 2 + 0.25pt}] leftlineend);

    % right line
    \draw[line width={\verticallinethickness}]
      ([xshift={- \offsetx - \verticallinethickness / 2 - 0.25pt}] rightlinestart) --
      ([xshift={- \offsetx - \verticallinethickness / 2 - 0.25pt}] rightlineend);
...
\framedbox[width=8cm, height=8cm, corner=\style, cornersize=4cm, mode=full]

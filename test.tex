    ...
    \ifthenelse{\NOT \equal{\getcornermetadata{\fbcorner}{horizontallinethickness2}}{0}}
    {
      \ifthenelse{\equal{\fblines}{all} \OR \equal{\fblines}{2}}
      {
        ...
        \draw[line width={\horizontallinethicknesssecond}]
          ([yshift={- \offsetysecond - \horizontallinethicknesssecond / 2 - 0.2pt}] toplinestart) --
          ([yshift={- \offsetysecond - \horizontallinethicknesssecond / 2 - 0.2pt}] toplineend);

        % bottom line
        \draw[line width={\horizontallinethicknesssecond}]
          ([yshift={\offsetysecond + \horizontallinethicknesssecond / 2 + 0.2pt}] bottomlinestart) --
          ([yshift={\offsetysecond + \horizontallinethicknesssecond / 2 + 0.2pt}] bottomlineend);

        % left line
        \draw[line width={\verticallinethicknesssecond}]
          ([xshift={\offsetxsecond + \verticallinethicknesssecond / 2 + 0.2pt}] leftlinestart) --
          ([xshift={\offsetxsecond + \verticallinethicknesssecond / 2 + 0.2pt}] leftlineend);

        % right line
        \draw[line width={\verticallinethicknesssecond}]
          ([xshift={- \offsetxsecond - \verticallinethicknesssecond / 2 - 0.2pt}] rightlinestart) --
          ([xshift={- \offsetxsecond - \verticallinethicknesssecond / 2 - 0.2pt}] rightlineend);
      }
      {}
    }
    {}
...
\framedbox[width=\textwidth, height=5.5cm, corner=\style, cornersize=2.5cm,
